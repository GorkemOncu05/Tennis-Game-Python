...
class Oyun():
    def __init__(self,oyuncu1,oyuncu2,top_grup):
        ...
        self.sayac=60
        self.fps_say=0
        self.oyun_font=pygame.font.Font("oyun_font.ttf",30)
    ...
    def cizdir(self):
        ...
        sayac_yazı=self.oyun_font.render("Kalan Süre:"+str(self.sayac),True,(0,50,100))
        sayac_yazı_konum=sayac_yazı.get_rect()
        sayac_yazı_konum.topleft=(GENISLIK//2-140,50)
        pencere.blit(puan1,puan1_konum)
        pencere.blit(puan2,puan2_konum)
        pencere.blit(sayac_yazı,sayac_yazı_konum)
    def temas(self):
